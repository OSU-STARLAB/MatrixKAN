...
# create KAN models
model_matrix = MatrixKAN(width=[2,5,1], grid=1, k=10, seed=42, device=device, grid_eps=1, symbolic_enabled=False)
model_reg = MultKAN(width=[2,5,1], grid=1, k=10, seed=42, device=device, grid_eps=1, symbolic_enabled=False)
