...
# train the model
model.fit(dataset, opt="LBFGS", steps=75, lamb=0.001, lr=1., update_grid=True)
# model.fit(dataset, opt="Adam", steps=75, lamb=0.001, lr=1.5, update_grid=False)
...
# model.fit(dataset, opt="Adam", steps=75, update_grid=False)
